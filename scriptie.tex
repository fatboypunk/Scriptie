...
\subsection{REST}
Representational state transfer (REST) is een webarchitectuur die de basis vormt voor het world wide web (www). REST

REST werkt erg simpel. Het gebruikt create read update en delete (CRUD) voor zijn acties, via http wordt dit aangeroepen met POST, GET, PUT en DELETE. Wat  
